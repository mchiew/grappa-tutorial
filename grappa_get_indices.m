...
%%  Note: You can achieve the same outcome, although much slower, by 
%%  using nested for-loops, and zooming over all of the k-space target
%%  points, identifying the indices for each target point and its 
